...
class gestorBab(Queue):
    ...
    def extend(self, items):
        self.A.extend(items)
        #Se reordena la lista teniendo en cuenta los path_cost
...
class gestorBab2(Queue):
    ...
    def extend(self, items):
        self.A.extend(items)
        # Se reordena la lista teniendo en cuenta los path_cost
        #Hay que añadirle la heuristica con h(x) con self.problem.h(x) contiene la heuristica del problema (self=this)
